...
def get_readable_time(seconds: int) -> str:
    ...
    return ping_time
PM_START_TEXT = """
`�Hey` (https://telegra.ph/file/b50f198f3d14bd6ff8725.jpg) `�I am` *�Albedo Bot*
`I'm Specifically Designed to Manage your Group with Ease ! Hit` *�Help & Commands ?*   
"""
buttons = [
    [
        InlineKeyboardButton(
            text="ᴬᵈᵈ ᴹᵉ ᵗᵒ ʸᵒᵘʳ ᴳʳᵒᵘᵖ", url="t.me/albedogroupbot?startgroup=true"),
    ],
     
     [  
        InlineKeyboardButton(text="ˢᵘᵖᵖᵒʳᵗ", url="https://t.me/waifuhunters"),
    ], 

    [
        InlineKeyboardButton(text="ᴴᵉˡᵖ & ᶜᵒᵐᵐᵃⁿᵈˢ❔", callback_data="help_back"),
    ],
]
HELP_STRINGS = """
`𝙷𝚎𝚢! I'm` *�Albedo Bot* (https://telegra.ph/file/3487a5bba7033dae56d0e.jpg)
`𝙲𝚕𝚒𝚌𝚔 𝚘𝚗 𝚝𝚑𝚎 𝚋𝚞𝚝𝚝𝚘𝚗𝚜 𝚋𝚎𝚕𝚘𝚠 𝚝𝚘 𝚐𝚎𝚝 𝚍𝚘𝚌𝚞𝚖𝚎𝚗𝚝𝚊𝚝𝚒𝚘𝚗 𝚊𝚋𝚘𝚞𝚝 𝚜𝚙𝚎𝚌𝚒𝚏𝚒𝚌 𝚖𝚘𝚍𝚞𝚕𝚎𝚜..`"""
DONATE_STRING = """Heya, glad to hear you want to donate!
 You can support the project via [Paypal](#) or by contacting @xeromax \
